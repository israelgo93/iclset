...
export function HeroSection({ locale }: HeroSectionProps) {
  ...
  const feesCtaLabel = locale === "es" ? "Ver valores" : "View fees";
    ...
    <section className="relative isolate overflow-hidden text-white">
      ...
      <div className="section-container relative z-10 py-16 sm:py-20 lg:py-28 xl:py-32">
        <div className="max-w-2xl">
          <motion.div
            className="border-iclset-cyan/30 text-iclset-cyan inline-flex items-center gap-2 rounded-full border bg-white/8 px-3 py-1.5 text-[0.7rem] font-semibold tracking-[0.18em] uppercase shadow-[0_8px_24px_-12px_rgb(31_211_240_/_0.45)] backdrop-blur"
            {...fadeUp(0)}
          >
            <Sparkles className="size-3.5" />
            {conference.acronym}
            <span className="bg-iclset-cyan/40 hidden h-3 w-px sm:inline-block" />

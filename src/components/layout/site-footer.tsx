	...
	return (
		<footer className="relative isolate overflow-hidden bg-gradient-to-b from-[oklch(15%_0.06_250)] via-[oklch(13%_0.05_252)] to-[oklch(10%_0.04_252)] text-white">
			...
			<div className="section-container grid gap-12 py-16 lg:grid-cols-[1.4fr_0.9fr_0.9fr]">
				<div>
					...
					>
						...
						<span>
							...
							<span className="text-xs font-medium tracking-[0.18em] text-iclset-cyan uppercase">
					...
					<p className="mt-5 max-w-md text-sm leading-6 text-white/68">
						...
						<span className="text-white/40">·</span> {conference.location.venue} {" "}
					...
					<div className="mt-5 flex flex-wrap items-center gap-x-4 gap-y-2 text-sm text-white/68">
						<span className="inline-flex items-center gap-2">
							<MapPin className="size-4 text-iclset-cyan" />
				...
				<div>
					<p className="text-xs font-semibold tracking-[0.18em] text-iclset-cyan uppercase">
					...
					<div className="mt-5 grid gap-2">
						{navigation.slice(0, 5).map((item) => (
							<Link
								...
								className="group inline-flex items-center gap-1 text-sm text-white/70 transition-colors hover:text-iclset-lime"
							>
								<span className="size-1.5 rounded-full bg-iclset-cyan/60 transition-all duration-300 group-hover:bg-iclset-lime group-hover:shadow-[0_0_12px_oklch(86%_0.20_130)]" />
								{item.label[locale]}
							</Link>
						))}
					</div>
				...
				<div>
					...
					<a
						...
						className="mt-5 inline-flex items-center gap-2 text-sm text-white/80 transition-colors hover:text-iclset-lime"
					>
